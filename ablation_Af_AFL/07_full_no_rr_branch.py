# -*- coding: utf-8 -*-
"""
消融实验 07：完整模型，但关闭 RR 分支（仅形态 + 噪声 + 模糊规则 + 边界感知）
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ablation 07: Full model without RR branch")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/ablation/07_full_no_rr")
