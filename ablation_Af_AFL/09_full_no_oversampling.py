...
def main():
    parser = argparse.ArgumentParser(description="Ablation 09: Full model without oversampling")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/ablation/09_full_no_oversampling")
    ...
    run_ablation(
        ...
        lr=args.lr,
        device=args.device,
        use_oversampling=False,  # 关键：关闭过采样
