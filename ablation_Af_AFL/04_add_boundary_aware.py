# -*- coding: utf-8 -*-
"""
消融实验 04：形态 + RR + 噪声分支 + 模糊规则 + 边界感知（完整方案）
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ablation 04: + Boundary-aware")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/ablation/04_boundary")
