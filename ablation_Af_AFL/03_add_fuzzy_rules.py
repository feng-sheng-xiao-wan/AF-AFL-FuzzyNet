# -*- coding: utf-8 -*-
"""
消融实验 03：形态 + RR + 噪声分支 + 模糊规则（边界感知关闭）
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ablation 03: + Fuzzy rules (no boundary aware)")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/ablation/03_fuzzy")
