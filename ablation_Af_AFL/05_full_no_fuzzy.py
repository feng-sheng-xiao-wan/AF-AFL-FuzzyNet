# -*- coding: utf-8 -*-
"""
消融实验 05：完整模型（形态 + RR + 噪声分支 + 边界感知），但取消模糊规则融合
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ablation 05: Full model without fuzzy rules")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/ablation/05_full_no_fuzzy")
